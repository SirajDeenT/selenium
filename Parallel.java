...
public class Parallel {
	...
	public class FirstTest extends BaseTest {
	    ...
	    public void GOOGLE2() {
	        ...
	        System.out.println("Google2 Test's Page title is: " + ((Object) getDriver()).getTitle() +" " + "Thread Id: " +  Thread.currentThread().getId());
	        Assert.assertEquals(((Object) getDriver()).getTitle(), "Google");
	    ...
	    public void GOOGLE3() {
	        ...
	        getDriver().navigate().to("http://www.google.com");
	        System.out.println("Google3 Test's Page title is: " + ((Object) getDriver()).getTitle() +" " + "Thread Id: " +  Thread.currentThread().getId());
	        Assert.assertEquals(((Object) getDriver()).getTitle(), "Google");
